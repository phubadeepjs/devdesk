...
export const allTools: Tool[] = [
  ...
  { id: 'base64-encoder', path: '/base64-encoder', name: 'Encoder/Decoder', icon: '🔐', feature: 'base64Encoder' },
  { id: 'prompt-generator', path: '/prompt-generator', name: 'Prompt Generator', icon: '✨', feature: 'promptGenerator' },
